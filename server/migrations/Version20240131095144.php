 ...
 */
final class Version20240131095144 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE planning_employee_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE planning_employee (id INT NOT NULL, employee_id INT DEFAULT NULL, appointment_id INT DEFAULT NULL, date_day DATE DEFAULT NULL, date_hour TIME(0) WITHOUT TIME ZONE DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_6A9A230C8C03F15C ON planning_employee (employee_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_6A9A230CE5B533F9 ON planning_employee (appointment_id)');
        ...
        $this->addSql('ALTER TABLE planning_employee ADD CONSTRAINT FK_6A9A230C8C03F15C FOREIGN KEY (employee_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE planning_employee ADD CONSTRAINT FK_6A9A230CE5B533F9 FOREIGN KEY (appointment_id) REFERENCES "appointment" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE planning_employee_id_seq CASCADE');
        ...
        $this->addSql('ALTER TABLE planning_employee DROP CONSTRAINT FK_6A9A230C8C03F15C');
        $this->addSql('ALTER TABLE planning_employee DROP CONSTRAINT FK_6A9A230CE5B533F9');
