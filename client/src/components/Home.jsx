  ...
  return (
    <main>
      <section id="section1">
        <div>
          <h1>
            Gagnez du temps et trouver un rendez-vous avec un professionnel de
            santé
          </h1>
      ...
      <div className="group-cadre">
        <div className="cadre">
          ...
          <div className="text">
            ...
            <li
              className="text-blue-600 cursor-pointer text-xl font-medium"
        ...
        <div className="cadre">
          ...
          <div className="text">
            <h2>Prendre RDV</h2>
            <p>
              Prenez rdv pour vous ou vos proches directement en ligne pour une
              téléconsultation ou visite en cabinet.
            </p>
            <li
              className="text-blue-600 cursor-pointer text-xl font-medium"
              onClick={handleNavigate}
        ...
        <div className="cadre">
          ...
          <div className="text">
            <h2>SMS de rappel</h2>
            <p>
              Un sms de rappel avec toutes les informations pratiques est envoyé
              avant le rdv
            </p>
            <li
              className="text-blue-600 cursor-pointer text-xl font-medium"
      ...
      <div id="section2">
        <div className="texte">
          ...
          <p>
            Nous nous engageons à protéger les données et la vie privée de nos
            utilisateurs. Nos utilisateurs bénéficient de technologies de
            chiffrement avancées. Les données personnelles de nos utilisateurs
            sont en lieu sûr.
          </p>
        </div>
        <div>
